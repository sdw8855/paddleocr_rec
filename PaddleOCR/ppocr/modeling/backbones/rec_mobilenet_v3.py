...
if __name__ == '__main__':
    params = {'scale':0.5,'model_name':'large'}
    model = MobileNetV3(params)
    data = fluid.layers.data(name='data', shape=[3, 32, 320], dtype='float32')
    ...
    fluid.save(fluid.default_startup_program(), params_path)